...
public class SubMenuOficina extends JFrame {
    public SubMenuOficina() {
        ...
        JButton btnPiezas = new JButton("3. Stock de Piezas");
        ...
        btnSoftware.addActionListener(e -> {
            String[] col = {"ID", "ID Equipo", "Programa", "Versión", "Últ. Actualización"};
        ...
        btnPiezas.addActionListener(e -> {
            String[] col = {"ID", "Nombre Pieza", "Stock Actual", "Últ. Fecha Mov.", "Estado de la Pieza"};
            String[] form = {"Nombre de Pieza", "Cantidad en Stock", "Fecha Movimiento (YYYY-MM-DD)", "Estado"};
            new VistaTabla("Inventario de Piezas", col, form, false).setVisible(true);
        });
